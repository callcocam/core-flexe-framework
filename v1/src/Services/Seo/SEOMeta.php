...
namespace Flexe\Services\Seo;

use Flexe\Services\Seo\Contracts\MetaTags as MetaTagsContract;
...
class SEOMeta implements MetaTagsContract
{
    ...
    public function getDefaultTitle()
    {
        if (empty($this->title_default)) {
            return array_get($this->config,'defaults.title', null);
        }
    ...
    public function getCanonical()
    {
        ...
        return $this->canonical ?: (($canonical_config === null) ? config('paths.base') : $canonical_config);
    }
