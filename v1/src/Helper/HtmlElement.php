...
use Flexe\Helper\Extras\Escaper;
...
class HtmlElement extends AbstractHelper
{
     ...
     * @return HtmlElement
     */
    public function __construct($tag, $text = '', array $attributes = array(), $renderHtml = true)
    {

        $this->setTag($tag);
        $this->setText($text);
        $this->setAttributes($attributes);
        $this->enableHtml($renderHtml);
    }
