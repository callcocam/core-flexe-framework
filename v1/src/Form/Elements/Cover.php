 ...
 * @author caltj
 */
class Cover extends AbstractElement {

    protected $type = 'file';
    protected $attrImg = '';
    protected $template = 'cover';
    ...
    public static function getOptionDefault($key, $default = null)
    {
        ...
        return array_get(self::$defaultOptions,sprintf('cover.%s',$key),$default);
    }
}
