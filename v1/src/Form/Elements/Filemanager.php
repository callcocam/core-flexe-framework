 ...
 * @author caltj
 */
class Filemanager extends AbstractElement {

    protected $type = 'hidden';
    protected $attrImg = '';
    protected $template = 'filemanager';
    ...
    public function render() {
        ...
        $html['cover'] = $this->partial('img',[
            'attr'=> $this->attrImg
        ]);

        $html['iframe'] = $this->partial('iframe',[
            'params'=> sprintf('/_cdn/plugins/filemanager/dialog.php?type=1&field_id=cover', config('paths.base'))
        ]);
